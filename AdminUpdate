...
#Buttons
add_btn = Button(f, text='Add', width=12)
add_btn.grid(row=3, column=0, pady=20)
rev_btn = Button(f, text='Delete', width=12)
rev_btn.grid(row=3, column=1)
update_btn = Button(f, text='Update', width=12)
update_btn.grid(row=3, column=2)
clear_btn = Button(f, text='Clear', width=12)
clear_btn.grid(row=4, column=0)
done_btn = Button(f, text='Done', width=12)
